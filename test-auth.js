...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var email, _a, data, error, _b, userRec, fetchError;
        var _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    console.log('Signup success:', (_c = data.user) === null || _c === void 0 ? void 0 : _c.id);
                    return [4 /*yield*/, supabase
                            .from('users')
                            .select('*')
                            .eq('user_id', (_d = data.user) === null || _d === void 0 ? void 0 : _d.id)
                            .single()];
                case 2:
                    _b = _e.sent(), userRec = _b.data, fetchError = _b.error;
                    if (fetchError) {
